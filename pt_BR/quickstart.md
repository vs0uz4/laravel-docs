...
- [Preparando o Banco de Dados](#prepping-the-database)
	...
	- [Modelos do Eloquent](#eloquent-models)
- [Roteando](#routing)
	- [Definindo as Rotas](#stubbing-the-routes)
	- [Exibindo a View](#displaying-a-view)
- [Construindo os Layouts e Views](#building-layouts-and-views)
	- [Definindo o Layout](#defining-the-layout)
	- [Definindo a View](#defining-the-child-view)
- [Adicionando Tarefas/Taks](#adding-tasks)
	- [Validação](#validation)
	- [Criando uma Tarefa](#creating-the-task)
	- [Exibindo as Tarefas Existentes](#displaying-existing-tasks)
...
Este guia de início rápido fornece uma introdução básica ao Framework Laravel abrangendo conteúdo sobre as migrações de banco de dados, do ORM Eloquent, roteamento, validação, views, e templates Blade. Este é um ótimo ponto de partida se você é novo no Framework Laravel ou  Frameworks PHP em geral. Se você já usou Laravel ou outros frameworks PHP, você pode querer consultar um dos nossos tutoriais mais avançados.

Para exemplificar uma seleção de características básicas do Laravel, vamos construir uma lista de tarefas simples que podemos utilizar para acompanhar todas as tarefas que desejarmos realizar (o típico exemplo "to-do list"). O código-fonte finalizado deste projeto está [disponível no GitHub](http://github.com/laravel/quickstart-basic) por completo.
...
Você é livre para seguir adiante e simplesmente ler o restante deste quickstart; no entanto, se você quiser fazer o download do código fonte deste tutorial e executá-lo em sua máquina local, você pode clonar o repositório Git e instalar suas dependências:
...
Para obter uma documentação mais completa sobre a contrução de um ambiente de desenvolvimento local Laravel, verifique a documentação completa sobre [Homestead](/docs/{{version}}/homestead) e [installation](/docs/{{version}}/installation).
...
## Construindo os Layouts e Views
...
#### Algumas Notas de Exclarecimento
...
#### Uma Nota Sobre o Método Spoofing
